...
user1 = User.create!(email: 'harry@mail.com', password: '123456')
file = URI.open('https://lh3.googleusercontent.com/proxy/ntc0Jov7auZiaBighc9RVgqXn1RUKRdniuZ8ZB7NqT4CdB-G5qSFBqwfGldBwzkUf0ulwreY4J2LxjAK5n6hXPLLRycJsPbelK0FSNyZqwdOevKuliC2wz1y3vgnDXERwERDgKYXTSeO1oPNpj8bLbIpid807w')
user1.photo.attach(io: file, filename: 'pict.jpg', content_type: 'image/jpg')
